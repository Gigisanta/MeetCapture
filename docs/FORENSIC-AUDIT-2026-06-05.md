...
**Verification:** User opens menu bar popover → sees branded hero card with dark glassmorphism, the product logos, current state clearly visible, upcoming meeting card with countdown. Premium look, not "fea".
